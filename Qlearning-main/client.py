...
s = cn.connect(2037)
q_table = np.loadtxt(r'C:\Qlearning-main-20231219T032701Z-001\Qlearning-main\resultado.txt')
...
while True:
    ...
    np.savetxt(r'C:\Qlearning-main-20231219T032701Z-001\Qlearning-main\resultado.txt', q_table, fmt="%f")